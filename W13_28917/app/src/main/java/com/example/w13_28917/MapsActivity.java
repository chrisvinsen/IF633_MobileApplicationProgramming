...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    List<MarkerAndShape> daftarMarkerAndShape = new ArrayList<MarkerAndShape>();
    List<LatLng> lokalTitiks = new ArrayList<LatLng>();
    Button btnTambah;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        daftarMarkerAndShape.add(new MarkerAndShape("Circle", "Area 500 m dari UMN", 500.0, lokalTitiks));
        lokalTitiks.clear();
